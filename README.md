...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/fragrant-mode-5fd3
```

A live public deployment of this template is available at [https://fragrant-mode-5fd3.templates.workers.dev](https://fragrant-mode-5fd3.templates.workers.dev)
